    ...
    <div class="row">
      <div class="col-sm-12 ">
        <div class="screenshot-contain">
          ...
          <carousel :class='"screenshot-carousel"' :loop=true :margin=30 :items=5 :center=true :nav=false :dots=false :dotsEach=false :autoplay=true
            :responsive="{0:{items:2,nav:false},767:{items:2,nav:false},768:{items:3,nav:false},992:{items:4,nav:false},1200:{items:5,nav:false}}">
