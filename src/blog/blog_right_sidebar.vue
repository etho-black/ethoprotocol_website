            ...
            <div class="col-md-7 col-sm-12 col-text-center">
              <nav aria-label="breadcrumb" class="blog-bradcrumb ">
                <ol class="breadcrumb bg-transparent mb-0">
                  ...
                  <li class="breadcrumb-item active"><router-link :to='"/tovo/blog_list"'>Blog Details</router-link></li>
                  <li class="breadcrumb-item active"><a href="#">Blog Details with Right Sidebar</a></li>
                </ol>
              </nav>
            </div>
          </div>
